 ...
 * Time: 8:24 PM
 */
public class HasComponent implements ConstraintResolver {

    private static ConstraintResolver instance = new HasComponent();
    ...
    public boolean check(CubeAgent agent, Variable subjectVariable, Variable objectVariable) {
        ...
        if (instance1_uuid != null && instance2_uuid != null) {
            ...
            if (rmController != null) {
                if (rmController.hasReferencedElement(instance1_uuid.toString(), Node.CORE_NODE_COMPONENTS, instance2_uuid.toString())) {
    ...
    public boolean performObjective(CubeAgent agent, Variable subjectVariable, Variable objectVariable) {
        ...
        if (instance1_uuid != null && instance2_uuid != null) {
            ...
            if (rmController != null) {
                try {
                if (rmController.addReferencedElement(instance1_uuid.toString(), Node.CORE_NODE_COMPONENTS, instance2_uuid.toString())) {
                    if (rmController.addReferencedElement(instance2_uuid.toString(), Component.CORE_COMPONENT_NODE, instance1_uuid.toString())) {
                        return true;
                    }
                }
    ...
    public boolean cancelObjective(CubeAgent agent, Variable subjectVariable, Variable objectVariable) {
        ...
        if (instance1_uuid != null && instance2_uuid != null) {
            RuntimeModelController rmController = agent.getRuntimeModelController();
            if (rmController != null) {
                if (rmController.removeReferencedElement(instance1_uuid.toString(), Node.CORE_NODE_COMPONENTS, instance2_uuid.toString())) {
                    if (rmController.removeReferencedElement(instance2_uuid.toString(), Component.CORE_COMPONENT_NODE, instance1_uuid.toString())) {
                        return true;
                    }
                }
            }
