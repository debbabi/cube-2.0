...
public class XMLParser implements ContentHandler, ErrorHandler {
    ...
    /**
     * End the document.
     * @throws org.xml.sax.SAXException : can never occrus.
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
        ...
        if (namespaceURI != null
                && (namespaceURI.equalsIgnoreCase(CoreExtensionBundle.NAMESPACE))) {
     ...
     * @throws org.xml.sax.SAXException the propagated exception
     ...
     * {@link System#out}.
     * @param saxparseexception the checking error
     * @throws org.xml.sax.SAXException nothing.
